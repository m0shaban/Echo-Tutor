...
class Config:
    ...
    # Conversation topics
    TOPICS = [
        {"id": "free", "label": "Free Talk", "icon": "💬", "prompt": "Have a natural, open-ended conversation."},
        {"id": "travel", "label": "Travel", "icon": "✈️", "prompt": "Discuss travel experiences, destinations, and planning trips."},
        {"id": "food", "label": "Food & Cooking", "icon": "🍳", "prompt": "Talk about food, recipes, restaurants, and cooking."},
        {"id": "tech", "label": "Technology", "icon": "💻", "prompt": "Discuss technology, gadgets, apps, and digital trends."},
        {"id": "movies", "label": "Movies & Shows", "icon": "🎬", "prompt": "Talk about movies, TV shows, actors, and entertainment."},
        {"id": "sports", "label": "Sports", "icon": "⚽", "prompt": "Discuss sports, fitness, athletes, and competitions."},
        {"id": "work", "label": "Work & Career", "icon": "💼", "prompt": "Practice professional English for interviews and workplace communication."},
        {"id": "daily", "label": "Daily Life", "icon": "🏠", "prompt": "Talk about daily routines, hobbies, family, and everyday activities."},
    ]
    ...
    BADGES = [
        {"id": "first_chat", "label": "First Chat", "icon": "🗣️", "description": "Complete your first conversation", "xp_req": 0, "condition": "messages >= 1"},
        {"id": "ten_messages", "label": "Chatterbox", "icon": "💬", "description": "Send 10 messages", "xp_req": 0, "condition": "messages >= 10"},
        {"id": "fifty_messages", "label": "Conversation Pro", "icon": "🏆", "description": "Send 50 messages", "xp_req": 0, "condition": "messages >= 50"},
        {"id": "first_correction", "label": "Learning!", "icon": "✏️", "description": "Receive your first correction", "xp_req": 0, "condition": "corrections >= 1"},
        {"id": "vocab_10", "label": "Word Collector", "icon": "📚", "description": "Learn 10 new words", "xp_req": 0, "condition": "vocab >= 10"},
        {"id": "streak_3", "label": "On Fire!", "icon": "🔥", "description": "3-day practice streak", "xp_req": 0, "condition": "streak >= 3"},
        {"id": "streak_7", "label": "Dedicated", "icon": "⚡", "description": "7-day practice streak", "xp_req": 0, "condition": "streak >= 7"},
        {"id": "streak_30", "label": "Unstoppable", "icon": "👑", "description": "30-day practice streak", "xp_req": 0, "condition": "streak >= 30"},
        {"id": "exercise_10", "label": "Practice Makes Perfect", "icon": "📝", "description": "Complete 10 exercises", "xp_req": 0, "condition": "exercises >= 10"},
        {"id": "level_5", "label": "Rising Star", "icon": "⭐", "description": "Reach Level 5", "xp_req": 500, "condition": "xp >= 500"},
        {"id": "level_10", "label": "Expert", "icon": "🌟", "description": "Reach Level 10", "xp_req": 1000, "condition": "xp >= 1000"},
        {"id": "perfect_pronun", "label": "Crystal Clear", "icon": "🎯", "description": "Get a 10/10 pronunciation score", "xp_req": 0, "condition": "perfect_pronun >= 1"},
    ]